...
from MonuMAI.symbolic_utils import get_axioms_attr_guarded_and_class, get_axioms_classes, SatAgg, LogitsToPredicateResnetTree, LogitsToPredicateMulticlass,LogitsToPredicateMultilabel
...
def run_epoch(resnet,P_classifier, optimizer, loader, total_loss_meter,ccentropy_loss_meter, sym_loss_metter, acc_meter, sat_meter, criterion, attr_criterion, args, is_training):
    ...
    for batch_idx, data in enumerate(loader):           
        ...
        axioms_attr_joint = get_axioms_attr_guarded_and_class(attr_outputs,labels_var, is_training,P_classifier)    
        ############################################
        losses = []
        ...
        ccentropy_loss_meter.update(-1)
        loss_main =  loss_symbolic
...
def train_X_to_C_to_y_soft_decision_tree_symbolic_fusion_and_class(args):  
...
def parse_arguments(experiment):
    ...
    parser.add_argument('exp', type=str,
                        choices=[ 'Joint_SoftDecisionTreeSymbolicFusionGuardedAndClass'],
